...
<body class="bg-[#0a0a0a] text-[#EDEDEC] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
                ...
                <div class="flex items-center justify-end gap-4">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="inline-block px-5 py-1.5 text-[#EDEDEC] border-[#3E3E3A] hover:border-[#62605b] border rounded-sm text-sm leading-normal transition-all duration-300">
                            Dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}"
                            class="inline-block px-5 py-1.5 text-[#EDEDEC] border border-transparent hover:border-[#3E3E3A] rounded-sm text-sm leading-normal transition-all duration-300">
                            Iniciar Sesión
                        </a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="inline-block px-5 py-1.5 text-[#EDEDEC] border-[#3E3E3A] hover:border-[#62605b] border rounded-sm text-sm leading-normal transition-all duration-300 bg-blue-600 hover:bg-blue-700">
                                Registrarse
                            </a>
                        @endif
                    @endauth
    ...
    <!-- Main Content -->
    <div
        class="flex items-center justify-center w-full transition-opacity pt-16 opacity-100 duration-750 lg:grow starting:opacity-0">
        <main
            class="flex max-w-[335px] w-full flex-col lg:max-w-6xl lg:flex-row items-center justify-center pt-16 lg:pt-0">
            <!-- Left Content Column -->
            <div class="lg:w-1/2 flex flex-col justify-center lg:pr-12 animate-fade-in">
                <h1
                    class="text-4xl lg:text-6xl font-bold mb-6 text-gradient bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">
                    Sistema de Resoluciones y Expedientes
                </h1>

                <p class="text-lg lg:text-xl text-gray-300 mb-8 animate-fade-in animate-delay-100">
                    Administra, organiza y gestiona tus expedientes y resoluciones de manera eficiente y segura con
                    SiRex.
                </p>

                <div class="flex flex-wrap gap-4 mb-12 animate-fade-in animate-delay-200">
                    <a href="{{ route('login') }}"
                        class="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium transition-all duration-300 flex items-center justify-center">
                    ...
                    <a href="#features"
                        class="px-8 py-3 border border-[#3E3E3A] hover:border-[#62605b] text-[#EDEDEC] rounded-md font-medium transition-all duration-300 flex items-center justify-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="lg:w-1/2 mt-12 lg:mt-0 animate-fade-in animate-delay-400">
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        <!-- Floating element 1 -->
                        <div class="absolute -top-12 -right-4 bg-[#1a1a1a] border border-[#2a2a2a] p-3 rounded-lg shadow-lg animate-float"
                        ...
                        <!-- Floating element 2 -->
                        <div class="absolute -bottom-6 -left-8 bg-[#1a1a1a] border border-[#2a2a2a] p-3 rounded-lg shadow-lg animate-float"
    ...
    <section id="features" class="w-full max-w-6xl py-24 animate-fade-in animate-delay-500">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Feature 1 -->
            <div
                class="bg-[#121212] border border-[#2a2a2a] p-6 rounded-xl hover:border-blue-500 transition-all duration-300">
                ...
                <p class="text-gray-400">Organiza y administra todos tus expedientes en un solo lugar con búsquedas
                    avanzadas y filtros personalizados.</p>
            </div>
            ...
            <div
                ...
                <p class="text-gray-400">Mantén un registro detallado de todas las resoluciones con fechas, estado
                    actual y documentación relacionada.</p>
            </div>
            ...
            <div
                ...
                <p class="text-gray-400">Sube, almacena y organiza todos los documentos PDF relacionados con tus
                    expedientes y resoluciones.</p>
            </div>
            ...
            <div
                ...
                <p class="text-gray-400">Clasifica y filtra expedientes por barrios y casas para una gestión localizada
                    y eficiente.</p>
            </div>
            ...
            <div
                ...
                <p class="text-gray-400">Sistema de permisos por roles y registro detallado de actividades para
            ...
            <div
                ...
                <p class="text-gray-400">Genera informes detallados y visualiza estadísticas para tomar decisiones
                    informadas sobre tus expedientes.</p>
            </div>
        </div>
    </section>
