{{-- resources/views/prototipos/reconocimiento-cuota-pagada-dos-veces.blade.php --}}
    ...
    <div class="sheet">
        ...
        <div class="header">
            ...
            <div class="header-right">
                <div class="header-title">Reconocimiento de Cuota Pagada Dos Veces</div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="referencia" contenteditable="true">
                REF.: RECONOCIMIENTO DE CUOTA PAGADA DOS VECES - CÓDIGO (<input type="text" x-model="codigo" maxlength="10" placeholder="[CÓDIGO]" onfocus="this.select()" style="background:transparent;border:none;outline:none;font-size:13px;font-weight:600;color:#1e40af;text-transform:uppercase;width:10ch;padding:0;margin:0;" />)
            </div>

            <!-- CUERPO -->
            <div class="cuerpo" contenteditable="true">
                Me dirijo a Ud. a los fines de que se realice el reconocimiento de la cuota pagada DOBLEMENTE segun la planilla adjuntada.
<br>
                Atte-
            </div>
            <!-- CUERPO 2 -->
            <div class="cuerpo-2" contenteditable="true">
                <div style="text-align:center; font-weight:bold; font-size:16px; margin-bottom:20px;">
                    RECONOCIMIENTO DE CUOTAS PAGADAS DOBLEMENTE
                </div>
                ...
                <p>en su carácter de adjudicatario del crédito identificado como</p>
                ...
                <p>Adjunta a la presente, copias de boletas pagadas dos veces por error.- Las detallamos a continuación:</p>
                ...
                <p>SOLICITA EL RECONOCIMIENTO DE LA CUOTA PAGADA EN EXCESO, EMITIENDO UNA CUOTA ADICIONAL ANTICIPADA A FIN DE QUE SE APLIQUE EL PAGO.- DEBERA CARGARSE EL PAGO, ASIGNANDO COMO N° DE TRANSFERENCIA EL QUE CORRESPONDE AL PRESENTE EXPEDIENTE:</p>
                ...
                <table style="width:100%; border-collapse:collapse; margin-bottom:20px; font-size:13px;">
                    <thead>
                        <tr style="background:#1e3a5f; color:white;">
                            ...
                            <th style="border:1px solid #ccc; padding:6px; text-align:center;">Importe Pagado</th>
                            <th style="border:1px solid #ccc; padding:6px; text-align:center;">Fecha de Pago</th>
                            <th style="border:1px solid #ccc; padding:6px; text-align:center;">Transferencia N°</th>
                        </tr>
                    </thead>
                    <tbody>
                        <template x-for="(row, i) in t2" :key="i">
                            <tr>
                                <td style="border:1px solid #ccc; padding:4px;"><input type="text" x-model="row.cuota" style="width:100%;text-align:center;background:transparent;border:none;outline:none;font-family:inherit;font-size:13px;color:#111827;" /></td>
                                <td style="border:1px solid #ccc; padding:4px;"><input type="text" x-model="row.vto" style="width:100%;text-align:center;background:transparent;border:none;outline:none;font-family:inherit;font-size:13px;color:#111827;" /></td>
                                <td style="border:1px solid #ccc; padding:4px;">$<input type="text" x-model="row.capital" style="width:80%;text-align:center;background:transparent;border:none;outline:none;font-family:inherit;font-size:13px;color:#111827;" /></td>
                                <td style="border:1px solid #ccc; padding:4px;">$<input type="text" x-model="row.pagado" style="width:80%;text-align:center;background:transparent;border:none;outline:none;font-family:inherit;font-size:13px;color:#111827;" /></td>
                                <td style="border:1px solid #ccc; padding:4px;"><input type="text" x-model="row.fpago" style="width:100%;text-align:center;background:transparent;border:none;outline:none;font-family:inherit;font-size:13px;color:#111827;" /></td>
                                <td style="border:1px solid #ccc; padding:4px;"><input type="text" x-model="row.transferencia" style="width:100%;text-align:center;background:transparent;border:none;outline:none;font-family:inherit;font-size:13px;color:#111827;" /></td>
                            </tr>
                        </template>
                    </tbody>
                </table>
                ...
                <div class="flex justify-center gap-2 mt-2 mb-4" contenteditable="false">
                    <button type="button" @click.stop="addRow('t2')" class="w-9 h-9 rounded-full bg-emerald-500 text-white text-xl font-bold leading-none shadow-sm hover:shadow-md hover:bg-emerald-600 hover:scale-110 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-emerald-300 flex items-center justify-center" style="cursor:pointer;">+</button>
                    <button type="button" @click.stop="removeRow('t2')" class="w-9 h-9 rounded-full bg-rose-500 text-white text-xl font-bold leading-none shadow-sm hover:shadow-md hover:bg-rose-600 hover:scale-110 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-rose-300 flex items-center justify-center" style="cursor:pointer;">−</button>
                </div>

                <p style="margin-bottom:10px;">Presto mi conformidad para aplicar las pautas precedentes</p>

                <p>En San Miguel de Tucumán, 20 de Mayo 2026, se firman dos ejemplares de un mismo tenor y a un solo efecto.-</p>
            </div>
        </div>
    </div>
